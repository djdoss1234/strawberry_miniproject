...
class CuroboPlanner(Node):
    ...
    def _pick(self, msg: PoseStamped):
        ...
        approach_open_msg = Int32()
        approach_open_msg.data = GRIPPER_APPROACH_POS
        self.gripper_pos_pub.publish(approach_open_msg)
        self.get_logger().info(
            f"1 open gripper for stem descent: position_cmd={GRIPPER_APPROACH_POS}")
        self.runtime_log.log(
            "gripper_command",
